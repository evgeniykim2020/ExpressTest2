...
class UpcomingDataSource(private val apiService: MovieDbInterface, private val compositeDisposable: CompositeDisposable) : PageKeyedDataSource<Int, Movie>() {
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, Movie>) {
        ...
        compositeDisposable.add(
            apiService.getUpcomingMovies(params.key)
